...
export default function ListingCard({ listing }: { listing: ListingDto }) {
    return (
        <div className="overflow-hidden relative h-150 p-2  transition-shadow duration-200 ease-in hover:shadow-[inset_0_0_0_2px_#000]">
            ...
            <Swiper
                ...
                modules={[Pagination]}
                className="bg-white mySwiper h-2/3"
            >
